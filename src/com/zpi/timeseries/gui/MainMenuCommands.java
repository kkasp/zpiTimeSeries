...
public class MainMenuCommands 
{
	...
	public final static String closeTxt = "Zamknij";
	public final static String generateTxt = "Generuj losowe dane";
	...
	public final static String corelationTxt = "Korelacja";
